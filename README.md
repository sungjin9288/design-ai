...
- Packed-tarball smoke also verifies `design-ai learn --signals --report --out learning-signals.md` Markdown signal reports and learn signals JSON `--out` file-write confirmations for installed-bin and one-shot `npm exec --package <tarball>` paths.
