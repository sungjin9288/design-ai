# `TablePagination` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/TablePagination/TablePagination.d.ts` (16 interface(s), 0 component(s))
...
- Mui: [`TablePagination.d.ts`](../refs/mui/packages/mui-material/src/TablePagination/TablePagination.d.ts)
