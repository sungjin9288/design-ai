# `StepConnector` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/StepConnector/StepConnector.d.ts` (3 interface(s), 1 component(s))
...
| --- | --- | --- | --- | --- | --- |
| `classes` | `Partial<StepConnectorClasses> \| undefined` | — | — | mui | Override or extend the styles applied to the component. |
...
- Mui: [`StepConnector.d.ts`](../refs/mui/packages/mui-material/src/StepConnector/StepConnector.d.ts)
