# `SnackbarContent` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/SnackbarContent/SnackbarContent.d.ts` (1 interface(s), 1 component(s))
...
| --- | --- | --- | --- | --- | --- |
| `action` | `React.ReactNode` | — | — | mui | The action to display. It renders after the message, at the end of the snackbar. |
| `classes` | `Partial<SnackbarContentClasses> \| undefined` | — | — | mui | Override or extend the styles applied to the component. |
| `message` | `React.ReactNode` | — | — | mui | The message to display. |
| `role` | `PaperProps['role'] \| undefined` | `'alert'` | — | mui | The ARIA role attribute of the element. |
...
- Mui: [`SnackbarContent.d.ts`](../refs/mui/packages/mui-material/src/SnackbarContent/SnackbarContent.d.ts)
