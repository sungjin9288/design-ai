# `TableFooter` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/TableFooter/TableFooter.d.ts` (3 interface(s), 0 component(s))
...
- Mui: [`TableFooter.d.ts`](../refs/mui/packages/mui-material/src/TableFooter/TableFooter.d.ts)
