# `TableContainer` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/TableContainer/TableContainer.d.ts` (3 interface(s), 0 component(s))
...
- Mui: [`TableContainer.d.ts`](../refs/mui/packages/mui-material/src/TableContainer/TableContainer.d.ts)
