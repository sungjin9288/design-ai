# `AccordionSummary` — spec (DRAFT — scaffolded 2026-05-10 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/AccordionSummary/AccordionSummary.d.ts` (9 interface(s), 0 component(s))
...
- Mui: [`AccordionSummary.d.ts`](../refs/mui/packages/mui-material/src/AccordionSummary/AccordionSummary.d.ts)
