# `StepButton` — spec (DRAFT — scaffolded 2026-05-11 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/StepButton/StepButton.d.ts` (4 interface(s), 0 component(s))
...
- Mui: [`StepButton.d.ts`](../refs/mui/packages/mui-material/src/StepButton/StepButton.d.ts)
