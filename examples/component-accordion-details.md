# `AccordionDetails` — spec (DRAFT — scaffolded 2026-05-10 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/AccordionDetails/AccordionDetails.d.ts` (1 interface(s), 1 component(s))
...
| `classes` | `Partial<AccordionDetailsClasses> \| undefined` | — | — | mui | Override or extend the styles applied to the component. |
...
- Mui: [`AccordionDetails.d.ts`](../refs/mui/packages/mui-material/src/AccordionDetails/AccordionDetails.d.ts)
