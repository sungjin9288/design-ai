# `ListItemButton` — spec (DRAFT — scaffolded 2026-05-10 via TS-AST)
...
>
> Sources analyzed:
> - **mui**: `refs/mui/packages/mui-material/src/ListItemButton/ListItemButton.d.ts` (4 interface(s), 0 component(s))
...
- Mui: [`ListItemButton.d.ts`](../refs/mui/packages/mui-material/src/ListItemButton/ListItemButton.d.ts)
