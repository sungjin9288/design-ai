...
REQUIRED_PATHS = {
    ...
    "cli/lib/design-quality-contract.mjs",
    "cli/lib/design-quality-inspector.mjs",
    "cli/lib/design-quality-report.schema.json",
    "cli/lib/artifact-contract.mjs",
    "cli/lib/start-contract.mjs",
    "cli/lib/product-review-inspector.mjs",
    "cli/lib/product-review-pack.mjs",
    "cli/lib/product-review-pack.schema.json",
    "cli/lib/browser-verification-contract.mjs",
    "cli/lib/browser-verification-runner.mjs",
    ...
    "cli/lib/start-operation.mjs",
    "cli/lib/start.mjs",
    "cli/lib/inspect.mjs",
    "cli/lib/review-workflow-contract.mjs",
    "cli/lib/review-workflow.mjs",
    "cli/lib/review.mjs",
    "cli/lib/review-handoff-contract.mjs",
    "cli/lib/review-handoff.mjs",
    "cli/lib/review-handoff-receipt-contract.mjs",
    "cli/lib/review-handoff-receipt.mjs",
    "cli/lib/target-repo-intake-contract.mjs",
    "cli/lib/target-repo-intake.mjs",
    "cli/lib/implementation-scope-request-contract.mjs",
    "cli/lib/implementation-scope-contract.mjs",
    "cli/lib/implementation-scope-approval-contract.mjs",
    "cli/lib/implementation-scope.mjs",
    "cli/lib/file-selector.mjs",
    "cli/lib/implementation-evidence-request-contract.mjs",
    "cli/lib/implementation-evidence-contract.mjs",
    "cli/lib/implementation-evidence.mjs",
    "cli/lib/pilot-record-contract.mjs",
    "cli/lib/pilot-evidence-contract.mjs",
    "cli/lib/pilot-evidence.mjs",
    "cli/lib/review-comparison-contract.mjs",
    "cli/lib/review-comparison.mjs",
    "cli/lib/review-pack.mjs",
    "cli/lib/specialization-benchmark-suite.mjs",
    "cli/lib/specialization-benchmark.mjs",
    "cli/commands/start.mjs",
    "cli/commands/inspect.mjs",
    "cli/commands/review.mjs",
    "cli/commands/review-handoff.mjs",
    "cli/commands/review-handoff-verify.mjs",
    "cli/commands/review-intake.mjs",
    "cli/commands/review-scope.mjs",
    "cli/commands/review-scope-approve.mjs",
    "cli/commands/review-evidence.mjs",
    "cli/commands/review-pilot.mjs",
    "cli/commands/review-compare.mjs",
    ...
    "cli/sdk/review-handoff-adapter.mjs",
    "cli/sdk/verify-review-handoff-adapter.mjs",
    "cli/sdk/implementation-scope-adapter.mjs",
    "cli/sdk/pilot-evidence-adapter.mjs",
    "cli/sdk/review-comparison-adapter.mjs",
    "cli/sdk/review-pack-adapter.mjs",
    "knowledge/PRINCIPLES.md",
    "examples/README.md",
    "examples/benchmarks/korean-fintech-settings/quality-report.json",
    "examples/benchmarks/korean-fintech-settings/source.html",
    "examples/benchmarks/korean-product-packs/korean-fintech/source.html",
    "examples/benchmarks/korean-product-packs/korean-commerce/source.html",
    "examples/benchmarks/korean-product-packs/korean-saas/source.html",
    "examples/benchmarks/korean-product-packs/korean-content/source.html",
    "examples/benchmarks/korean-product-packs/korean-game/source.html",
    ...
    "examples/benchmarks/product-specialization/multi-agent-handoff/source.html",
    "product-packs/korean-fintech.json",
    "product-packs/korean-commerce.json",
    "product-packs/korean-saas.json",
    "product-packs/korean-content.json",
    "product-packs/korean-game.json",
    "skills/component-spec-writer/PLAYBOOK.md",
    "commands/design-from-brief.md",
    "docs/DISTRIBUTION.md",
    "docs/DISTRIBUTION.ko.md",
    "docs/DESIGN-QUALITY-CONTRACT.md",
    "docs/REVIEW-WORKFLOW.md",
    "docs/REVIEW-WORKFLOW.ko.md",
    "docs/REVIEW-HANDOFF.md",
    "docs/REVIEW-HANDOFF.ko.md",
    "docs/REVIEW-INTAKE.md",
    "docs/REVIEW-INTAKE.ko.md",
    "docs/IMPLEMENTATION-SCOPE.md",
    "docs/IMPLEMENTATION-SCOPE.ko.md",
    "docs/IMPLEMENTATION-REVIEW-EVIDENCE.md",
    "docs/IMPLEMENTATION-REVIEW-EVIDENCE.ko.md",
    "docs/REAL-PILOT-EVIDENCE.md",
    "docs/REAL-PILOT-EVIDENCE.ko.md",
    "docs/REVIEW-COMPARISON.md",
    "docs/REVIEW-COMPARISON.ko.md",
    "docs/BROWSER-VERIFICATION.md",
    "docs/PRODUCT-SPECIALIZATION-PLAN.md",
    "docs/BENCHMARKS.md",
    "docs/BENCHMARKS.ko.md",
    "docs/case-studies/new-design-contract.md",
    "docs/case-studies/existing-product-refactor.md",
    "docs/case-studies/korean-product-ux.md",
    "docs/case-studies/multi-agent-handoff.md",
    "docs/case-studies/verified-design-iteration.md",
    "docs/QUICKSTART.md",
    ...
    "docs/website-console/implementation-scope.js",
    "docs/website-console/implementation-evidence.js",
