...
RELEASE_SITE_MCP_PLAN_PACKAGE_SMOKE_TERM_GROUPS = (
    ...
    (
        "Website Console MCP probe action plan JSON with `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "Website Console MCP probe action plan JSON `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "Website Console MCP probe action plan JSON with --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "Website Console MCP probe action plan JSON --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "MCP probe action plan JSON with `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "MCP probe action plan JSON `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "MCP probe action plan JSON with --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "MCP probe action plan JSON --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        "MCP probe action plan JSON output-file persistence",
        "MCP probe action plan JSON `--out` file 저장 확인과 MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
    ),
    (
        "installed-bin and one-shot",
        "installed-bin plus one-shot",
...
RELEASE_SITE_MCP_ACTION_PLAN_COMMANDS_TERM_GROUPS = (
    (
        "embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        ...
        "MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
    ),
)
RELEASE_SITE_MCP_ACTION_PLAN_HUMAN_OUTPUT_COMMAND_TERM_GROUPS = (
    (
        "MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
        ...
        "MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage 검증",
    ),
)
RELEASE_SITE_MCP_ACTION_PLAN_HUMAN_OUTPUT_COMMAND_SMOKE_TERM_GROUPS = (
    (
        "MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
...
`design-ai site --stdin --mcp-plan --probes --json` Website Console MCP probe action plan JSON 생성과 `--out` file 저장 확인 및 MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage도 확인하고,
...
"""
    ...
    site_mcp_action_plan_embedded_command_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
                "",
            ),
        },
        audit_count=8,
    ...
    assert_condition(
        ...
        "release policy docs should mention embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
    )
    ...
    site_mcp_action_plan_human_output_command_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " plus MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
                "",
            ),
        },
        audit_count=8,
    ...
    assert_condition(
        ...
        "release policy docs should mention MCP action plan human report output command parity plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
    )
    ...
    site_mcp_action_plan_human_output_command_smoke_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " plus MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
                "",
            ),
        },
        audit_count=8,
    ...
    assert_condition(
        ...
        "release policy docs should mention MCP action plan emitted human report command smoke coverage plus MCP action plan emitted self-archive command smoke coverage",
    )
