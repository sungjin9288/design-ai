...
RELEASE_SITE_MCP_PLAN_PACKAGE_SMOKE_TERM_GROUPS = (
    ...
    (
        "Website Console MCP probe action plan JSON with `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "Website Console MCP probe action plan JSON `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "Website Console MCP probe action plan JSON with --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "Website Console MCP probe action plan JSON --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "MCP probe action plan JSON with `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "MCP probe action plan JSON `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "MCP probe action plan JSON with --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "MCP probe action plan JSON --out file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        "MCP probe action plan JSON output-file persistence",
        "MCP probe action plan JSON `--out` file 저장 확인과 MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity",
    ),
    (
        "installed-bin and one-shot",
        "installed-bin plus one-shot",
...
RELEASE_SITE_MCP_ACTION_PLAN_COMMANDS_TERM_GROUPS = (
    (
        "embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
        ...
        "MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity",
    ),
)
RELEASE_SITE_MCP_ACTION_PLAN_HUMAN_OUTPUT_COMMAND_TERM_GROUPS = (
    (
        "MCP action plan human report output command parity",
        ...
        "MCP action plan human report output command parity 검증",
    ),
)
...
`design-ai site --stdin --mcp-plan --probes --json` Website Console MCP probe action plan JSON with `--out` file-write confirmation plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity,
...
`design-ai site --stdin --mcp-plan --probes --json` Website Console MCP probe action plan JSON 생성과 `--out` file 저장 확인 및 MCP action plan 내장 probe output-file commands plus MCP action plan human report output command parity도 확인하고,
...
"""
    ...
    site_mcp_action_plan_embedded_command_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " plus embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
                "",
            ),
        },
        audit_count=8,
    ...
    assert_condition(
        ...
        "release policy docs should mention embedded MCP action plan probe output-file commands plus MCP action plan human report output command parity",
    )
    ...
    site_mcp_action_plan_human_output_command_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " plus MCP action plan human report output command parity",
                "",
            ),
        },
        audit_count=8,
    ...
    assert_condition(
        ...
        "release policy docs should mention MCP action plan human report output command parity",
    )
