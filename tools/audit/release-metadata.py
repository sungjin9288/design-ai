...
RELEASE_LEARN_PROPOSE_SKILLS_REVIEW_CHECK_PACKAGE_SMOKE_TERM_GROUPS = (
    (
        "`design-ai learn --propose-skills --review-file skill-proposals.review.json --review-check --json`",
        "design-ai learn --propose-skills --review-file skill-proposals.review.json --review-check --json",
    ),
    (
        "read-only review-file readiness check",
        "read-only review-file readiness checks",
        "review-file readiness check",
    ),
    (
        "installed-bin and one-shot",
        "installed-bin plus one-shot",
...
RELEASE_LEARN_PROPOSE_SKILLS_REVIEW_CHECK_MARKDOWN_PACKAGE_SMOKE_TERM_GROUPS = (
    (
        "`design-ai learn --propose-skills --review-file skill-proposals.review.json --review-check --report --out skill-proposal-review-check.md`",
        "design-ai learn --propose-skills --review-file skill-proposals.review.json --review-check --report --out skill-proposal-review-check.md",
        "review-check `--report --out skill-proposal-review-check.md`",
    ),
    (
        "read-only review-check Markdown report",
        "read-only review-check Markdown reports",
        "review-check Markdown report",
        "review-file readiness Markdown report",
    ),
    (
        "installed-bin and one-shot",
        "installed-bin plus one-shot",
...
RELEASE_LEARN_PROPOSE_SKILLS_APPLY_PLAN_PACKAGE_SMOKE_TERM_GROUPS = (
    (
        "`design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan --json`",
        "design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan --json",
        "read-only apply-plan `--apply-plan --json`",
    ),
    (
        "read-only accepted proposal apply plan",
        "read-only accepted proposal apply plans",
        "accepted proposal apply-plan",
        "manual apply plan",
    ),
    (
        "installed-bin and one-shot",
...
RELEASE_LEARN_PROPOSE_SKILLS_APPLY_PLAN_HUMAN_CONTRACT_PACKAGE_SMOKE_TERM_GROUPS = (
    (
        "`design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan`",
        "design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan",
    ),
    (
        "human apply-plan command contract",
        "human apply-plan command contract summary",
        "human apply-plan `Command contract`",
    ),
    (
        "`Command contract`",
...
RELEASE_LEARN_PROPOSE_SKILLS_APPLY_PLAN_MARKDOWN_PACKAGE_SMOKE_TERM_GROUPS = (
    (
        "`design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan --report --out skill-proposal-apply-plan.md`",
        "design-ai learn --propose-skills --review-file skill-proposals.review.json --apply-plan --report --out skill-proposal-apply-plan.md",
        "apply-plan `--report --out skill-proposal-apply-plan.md`",
    ),
    (
        "read-only apply-plan Markdown report",
        "read-only apply-plan Markdown reports",
        "accepted proposal apply-plan Markdown report",
        "manual apply-plan Markdown report",
    ),
    (
        "installed-bin and one-shot",
        "installed-bin plus one-shot",
...
RELEASE_POLICY_PHRASE_LABELS = (
    ...
    "learn propose-skills review-check package smoke phrase",
    "learn propose-skills review-check Markdown package smoke phrase",
    "learn propose-skills apply-plan package smoke phrase",
    "learn propose-skills apply-plan human command contract package smoke phrase",
    "learn propose-skills apply-plan Markdown package smoke phrase",
...
`design-ai site --from-intake` Website Console from-intake filled Markdown intake import coverage for workspace JSON stdout, stdin workspace JSON stdout, stdin next-actions JSON stdout, stdin next-actions JSON `--out` file output-file persistence, stdin next-actions human `--out` file output-file persistence, stdin workspace JSON `--out` file output-file persistence, workspace JSON `--out` file output-file persistence, from-intake task generation, stdin from-intake task JSON `--out` output-file persistence, stdin handoff bundle generation, and from-intake handoff bundle generation in installed-bin and one-shot paths,
...
`design-ai site --from-intake` Website Console from-intake filled Markdown intake import coverage for workspace JSON stdout, stdin workspace JSON stdout, stdin next-actions JSON stdout, stdin next-actions JSON `--out` file output-file persistence, stdin next-actions human `--out` file output-file persistence, stdin workspace JSON `--out` file output-file persistence, workspace JSON `--out` file output-file persistence, from-intake task generation, stdin from-intake task JSON `--out` output-file persistence, stdin handoff bundle generation, and from-intake handoff bundle generation in installed-bin과 one-shot paths도 확인하고,
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                ...
                "Website Console from-intake filled Markdown intake import coverage for workspace JSON stdout, stdin workspace JSON stdout, stdin next-actions JSON stdout, stdin next-actions JSON `--out` file output-file persistence, stdin next-actions human `--out` file output-file persistence, stdin workspace JSON `--out` file output-file persistence, workspace JSON `--out` file output-file persistence, from-intake task generation, stdin from-intake task JSON `--out` output-file persistence, stdin handoff bundle generation, and from-intake handoff bundle generation in installed-bin and one-shot paths",
