...
"""
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                ...
                "agent backlog strict gate, focused agent backlog readiness summaries, and check-capture optional-gap semantics in installed-bin and one-shot paths",
    ...
    learn_agent_backlog_readiness_package_smoke_drift = release_metadata_summary(
        ...
        release_policy_docs={
            **release_policy_docs,
            "README.md": english_policy_doc.replace(
                " focused agent backlog readiness summaries, and check-capture optional-gap semantics",
                "",
            ),
        },
        audit_count=8,
