...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "learn": "design-ai learn [--init|--remember text|--feedback text|--list|--export|--query text|--explain|--backup|--redact|--verify|--diff|--restore|--restore-backups [--prune]|--import|--audit [--fix]|--curate|--stats|--usage|--signals [--strict]|--propose-skills [--strict]|--eval-template|--eval [--strict]|--forget id|--clear] [--json|--report] [--out file]",
...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "--signals",
        "design-ai learn --propose-skills [--from-file signal-file-or-dir] [--usage-file path] [--strict] [--json|--report] [--out file] [--force]",
        "--propose-skills",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--init|--remember text|--feedback text|--list|--export|--query text|--explain|--backup|--redact|--verify|--diff|--restore|--restore-backups [--prune]|--import|--audit [--fix]|--curate|--stats|--usage|--signals [--strict]|--propose-skills [--strict]|--eval-template|--eval [--strict]|--forget id|--clear] [--json|--report] [--out file]",
