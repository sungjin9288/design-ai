...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "learn": "design-ai learn [--remember text|--list|--export|--audit|--forget id|--clear] [--json]",
...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": ("Usage:", "design-ai learn [--list] [--category kind] [--limit N] [--json]", "design-ai learn --audit [--json]", "design-ai learn --forget id-or-number --yes [--json]", "local memory, not model training or fine-tuning"),
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--remember text|--list|--export|--audit|--forget id|--clear]",
...
def passing_main_help_output() -> str:
    return "\n".join([
        ...
        "  learn [--remember text|--list|--export|--audit|--forget id|--clear] [--json]",
