...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "learn": "design-ai learn [--remember text|--list|--export|--audit [--fix]|--stats|--forget id|--clear] [--json]",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--remember text|--list|--export|--audit [--fix]|--stats|--forget id|--clear]",
...
def passing_main_help_output() -> str:
    return "\n".join([
        ...
        "  learn [--remember text|--list|--export|--audit [--fix]|--stats|--forget id|--clear] [--json]",
