...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "learn": "design-ai learn [--remember text|--feedback text|--list|--export|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear] [--json]",
...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "cat learning.json | design-ai learn --import --stdin --yes [--json]",
        "--feedback",
        "--outcome",
        "--backup",
        "--redact",
        ...
        "design-ai learn --audit --fix --dry-run [--json]",
        "design-ai learn --audit --fix --yes [--json]",
        "--fix",
        "--dry-run",
        "design-ai learn --stats [--json]",
        "design-ai learn --forget id-or-number --yes [--json]",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--remember text|--feedback text|--list|--export|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear]",
...
def passing_main_help_output() -> str:
    return "\n".join([
        ...
        "  learn [--remember text|--feedback text|--list|--export|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear] [--json]",
