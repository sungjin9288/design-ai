...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "--signals",
        "design-ai learn --propose-skills [--from-file signal-file-or-dir] [--usage-file path] [--review-file path] [--min-evidence N] [--strict] [--json|--report|--patch|--review-template] [--out file] [--force]",
        "--propose-skills",
        "--patch",
        "--review-template",
        "--min-evidence",
