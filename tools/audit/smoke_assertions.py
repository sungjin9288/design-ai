...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "--signals",
        "design-ai learn --propose-skills [--from-file signal-file-or-dir] [--usage-file path] [--review-file path] [--min-evidence N] [--strict] [--json|--report|--patch] [--out file] [--force]",
        "--propose-skills",
        "--patch",
        "--min-evidence",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--init|--remember text|--feedback text|--list|--export|--query text|--explain|--backup|--redact|--verify|--diff|--restore|--restore-backups [--prune]|--import|--audit [--fix]|--curate|--stats|--usage|--signals [--strict]|--propose-skills [--min-evidence N] [--review-file path] [--strict]|--eval-template|--eval [--strict]|--forget id|--clear] [--json|--report|--patch] [--out file]",
