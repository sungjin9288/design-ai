...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "design-ai learn --propose-skills [--from-file signal-file-or-dir] [--usage-file path] [--review-file path] [--review-check] [--min-evidence N] [--strict] [--json|--report|--patch|--review-template] [--out file] [--force]",
        "--propose-skills",
        "--patch",
        "--review-check",
        "--review-template",
