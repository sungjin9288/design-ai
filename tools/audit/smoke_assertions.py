...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "learn": "design-ai learn [--remember text|--feedback text|--list|--export|--query text|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear] [--json] [--out file]",
...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        "Usage:",
        "design-ai learn [--list] [--category kind] [--query text] [--limit N] [--json] [--out file] [--force]",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--remember text|--feedback text|--list|--export|--query text|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear]",
...
def passing_main_help_output() -> str:
    return "\n".join([
        ...
        "  learn [--remember text|--feedback text|--list|--export|--query text|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear] [--json] [--out file]",
