...
EXPECTED_HELP_TOPIC_USAGES = {
    ...
    "site": "design-ai site <workspace.json|--stdin> [--strict] [--json|--mcp-check|--mcp-plan|--graph|--tasks|--bundle|--report|--prompts|--prompt id [--task id]] [--out file] | site <bundle-dir> --bundle-check [--json] | site <bundle-dir> --bundle-compare other-bundle-dir [--json] | site <bundle-dir> --bundle-handoff [--json] | site <bundle-dir> --bundle-repair [--yes] [--json] | site --sample [--out file] | site --prompt-list [--json]",
...
EXPECTED_HELP_TOPIC_FRAGMENTS = {
    ...
    "learn": (
        ...
        "--usage",
        "design-ai learn --signals [--from-file signal-file-or-dir] [--usage-file path] [--json] [--out file] [--force]",
        "--signals",
        "design-ai learn --propose-skills [--from-file signal-file-or-dir] [--usage-file path] [--json] [--out file] [--force]",
        "--propose-skills",
        "--usage-file path",
    ...
    "site": (
        ...
        "design-ai site <bundle-dir> --bundle-repair [--yes] [--strict] [--json]",
...
EXPECTED_MAIN_HELP_FRAGMENTS = (
    ...
    "examples [query]",
    "learn [--init|--remember text|--feedback text|--list|--export|--query text|--explain|--backup|--redact|--verify|--diff|--restore|--restore-backups [--prune]|--import|--audit [--fix]|--curate|--stats|--usage|--signals|--propose-skills|--eval-template|--eval|--forget id|--clear] [--json|--report] [--out file]",
...
def passing_main_help_output() -> str:
    return "\n".join([
        ...
        "  site <workspace.json|--stdin> [--strict] [--json|--mcp-check|--mcp-plan|--graph|--tasks|--bundle|--report|--prompts|--prompt id [--task id]] [--out file] | site <bundle-dir> --bundle-check [--json] | site <bundle-dir> --bundle-compare other-bundle-dir [--json] | site <bundle-dir> --bundle-handoff [--json] | site <bundle-dir> --bundle-repair [--yes] [--json] | site --sample [--out file] | site --prompt-list [--json]",
