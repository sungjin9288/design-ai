...
test("runHelp lists advanced options supported by command parsers", async () => {
  ...
  assert.match(
    output,
    /learn \[--remember text\|--feedback text\|--list\|--export\|--query text\|--explain\|--backup\|--redact\|--verify\|--import\|--audit \[--fix\]\|--stats\|--forget id\|--clear\] \[--json\] \[--out file\]\s+Manage local learning preferences for prompt personalization/,
  );
  assert.ok(
