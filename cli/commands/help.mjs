...
export const HELP_COMMANDS = [
  ...
  { topic: "site", usage: "site <workspace.json|--stdin> [--strict] [--json|--mcp-check|--tasks|--report|--prompts|--prompt id [--task id]] [--out file] | site --sample [--out file] | site --prompt-list [--json]", description: "Validate Website Improvement Console exports and generate handoff artifacts" },
