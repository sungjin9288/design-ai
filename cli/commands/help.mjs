...
export const HELP_COMMANDS = [
  ...
  { topic: "learn", usage: "learn [--remember text|--feedback text|--list|--export|--backup|--import|--audit [--fix]|--stats|--forget id|--clear] [--json]", description: "Manage local learning preferences for prompt personalization" },
