...
export const HELP_COMMANDS = [
  ...
  { topic: "workspace", usage: "workspace [--root path] [--learning-file path] [--json]", description: "Show read-only local dogfood readiness: git, repository, learning, and release scripts" },
