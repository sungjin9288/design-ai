...
export const HELP_COMMANDS = [
  ...
  { topic: "learn", usage: "learn [--remember text|--list|--export|--audit|--stats|--forget id|--clear] [--json]", description: "Manage local learning preferences for prompt personalization" },
