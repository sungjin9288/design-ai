...
export const HELP_COMMANDS = [
  ...
  { topic: "learn", usage: "learn [--init|--remember text|--feedback text|--list|--export|--query text|--explain|--backup|--redact|--verify|--diff|--restore|--restore-backups [--prune]|--import|--audit [--fix]|--curate|--stats|--usage|--signals [--strict]|--propose-skills|--eval-template|--eval [--strict]|--forget id|--clear] [--json|--report] [--out file]", description: "Manage local learning preferences, usage reports, signal registry, skill proposals, and eval checkpoints for prompt personalization" },
