...
export const HELP_COMMANDS = [
  ...
  { topic: "learn", usage: "learn [--remember text|--feedback text|--list|--export|--query text|--backup|--redact|--verify|--import|--audit [--fix]|--stats|--forget id|--clear] [--json] [--out file]", description: "Manage local learning preferences for prompt personalization" },
