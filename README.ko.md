...
핵심 디자인 컨설팅 워크플로우는 로컬 릴리스 기준으로 준비되어 있어요. AI 모델 학습이나 fine-tuning은 현재 배포 범위가 아니며, design-ai는 범용 AI 에이전트 위에서 동작하는 구조화된 corpus, routing, prompt-pack, QA layer예요.
