...
- 릴리스 PR 또는 태그 전에는 `npm run release:check`를 실행해요. CLI unit test, 7개 audit, whitespace check, package contents check, `npm run release:self-test`, command-specific help topic 출력 검증을 포함한 packed-tarball smoke를 한 번에 확인해요.
