...
- 1. Hero
- 2. Problem intro
- 3. Comparison table (product vs competitors)
- 4. Pricing (optional)
- 5. CTA
...
- 2. Lead magnet preview (ebook cover
- checklist
- etc)
- 3. Form (minimal fields)
- 4. CTA submit
...
- 2. Comparison matrix (you vs competitors)
- 3. Feature deep-dive
- 4. Winner CTA
...
**Section order**:
- 1. Hero (date/location/countdown)
- 2. Speakers grid
- 3. Agenda/schedule
- 4. Sponsors
- 5. Register CTA
...
**Section order**:
- 1. Full-bleed Hero (headline + visual)
