...
- In that packed-tarball smoke gate, workspace readiness coverage includes `design-ai workspace --json` plus strict failure/success readiness checks for `design-ai workspace --strict --json` in both installed-bin and one-shot npm exec paths.
