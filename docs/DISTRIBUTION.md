...
design-ai learn      Manage local learning preferences; use --backup --json for a full portable profile backup and --import for confirmed profile merges
