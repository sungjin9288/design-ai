...
design-ai learn      Manage local learning preferences; use --backup --json for a full portable profile backup, --redact --json for a redacted shareable backup, and --import for confirmed profile merges
