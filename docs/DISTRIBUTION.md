...
design-ai site file   Validate Website Improvement Console JSON exports and generate handoff artifacts; add --stdin, --sample, --strict, --json, --mcp-check, --probes, --mcp-plan, --graph, --tasks, --bundle, --bundle-check, --bundle-compare, --bundle-handoff, --report, --prompts, --prompt id, --task id, --out file, or --force
