...
design-ai learn      Manage local learning preferences; use --backup --json for a full portable profile backup, --redact --json / --redact --from-file / --redact --stdin for redacted shareable backups, and --import for confirmed profile merges
