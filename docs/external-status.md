...
`v5.2.0` is public. The Homebrew formula was retargeted to the new tag but has
not been re-verified by a tap install. The release exposes 21 skills, 16 public
...
| Homebrew tap | `Formula/design-ai.rb` | Formula retargeted to `v5.2.0` with source SHA-256 `216ed71227c4f7b7e317702594ae45af2f1e8cf62795b80aefda92e21453dce2`, computed from the published tag tarball. `brew style`, temporary-tap source install, and `brew test` have **not** been re-run for this version. | `Formula/design-ai.rb`; tag tarball digest verified 2026-09-18 |
...
- v5.2.0 is distributed on npm and as a GitHub Release. The Homebrew formula points at the new tag but is not re-verified.
