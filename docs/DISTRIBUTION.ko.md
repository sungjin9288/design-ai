...
design-ai learn      local learning preference 관리; --backup --json은 전체 portable profile backup을 만들고 --import는 확인된 profile merge를 수행
