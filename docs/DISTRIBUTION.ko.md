...
design-ai workspace   git, repository metadata, learning, release script 상태를 보는 read-only local dogfood readiness snapshot; --root path/--learning-file path/--strict/--json 지원
