...
design-ai learn      local learning preference 관리; --backup --json은 전체 portable profile backup, --redact --json / --redact --from-file / --redact --stdin은 공유용 redacted backup을 만들고, --out file과 --force로 안전한 artifact 저장을 지원하며, --import는 확인된 profile merge를 수행
