...
같은 `npm run release:check` gate는 Website Console bundle boundary metadata guard 단계도 bundle-check JSON/human and bundle-handoff JSON/prompt boundary metadata, package contents, release self-tests, packed-tarball smoke와 함께 보존해요.
