...
- Public registry workspace learning-eval coverage는 공개 npm registry `design-ai workspace --learning-eval learning-eval.json --strict --json` checkpoint summary와 freshness metadata를 published package path에서 확인해요.
