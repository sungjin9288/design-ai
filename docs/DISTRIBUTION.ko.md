...
design-ai site file   Website Improvement Console JSON export 검증 및 handoff artifact 생성; --stdin/--strict/--json/--report/--prompts/--out file/--force 지원
...
- packed-tarball smoke gate에서는 installed-bin과 one-shot npm exec 양쪽에서 `design-ai workspace --json`, `design-ai workspace --strict --json` strict 실패/성공 readiness 동작, `design-ai site --stdin --json` Website Console export validation을 함께 검증.
