...
design-ai learn      local learning preference 관리; --backup --json은 전체 portable profile backup, --redact --json / --redact --from-file / --redact --stdin은 공유용 redacted backup을 만들고 --import는 확인된 profile merge를 수행
