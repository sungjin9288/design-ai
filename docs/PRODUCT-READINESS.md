...
Current status: **core design consulting product is locally release-ready; local learning preferences and explicit check feedback capture are shipped; model training is not part of the shipped product.**
