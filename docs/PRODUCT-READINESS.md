...
| Local AI learning preferences | Complete for v4.13 | `design-ai learn`, `prompt --with-learning`, and `pack --with-learning` provide explicit local preference memory | Keep privacy boundaries clear and user-controlled |
...
- Store explicit local learning preferences and inject them into prompts/packs only when requested.
