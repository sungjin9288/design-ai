...
19개 스킬, 15개 명령어, 4개 리뷰 에이전트가 `~/.claude/` 아래에 심볼릭 링크로 설치돼요. Claude Code를 다시 시작(또는 새 세션 열기)하면 적용돼요.
...
19 skills, 4 agents, 15 commands가 설치되었다고 나와야 해요.
