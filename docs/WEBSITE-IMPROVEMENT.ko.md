...
| Operator Runbook | `design-ai site <bundle-dir> --bundle-handoff --json` 결과를 import해 stage metric, action/evidence row filter, status index, evidence progress, copy-ready stage row, filtered-row Markdown copy, next-line copy action을 검토 |
